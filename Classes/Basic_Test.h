...
#pragma endregion
    ...
    unsigned char* data = stbi_load("Resources/container.jpg",
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    data = stbi_load("Resources/awesomeface.png",
        &width, &height, &nrChannels, 0);
    if (data) {
...
#pragma endregion
    ...
    auto myShader = new Shader("Shaders/glm.vert", "Shaders/glm.frag");
    myShader->use();
    myShader->setInt("texture1", 0);
    myShader->setInt("texture2", 1);
...
#pragma endregion
    ...
    auto myShader = new Shader("Shaders/basic_trans.vert", "Shaders/basic_trans.frag");
    myShader->use();
    myShader->setInt("texture1", 0);
    myShader->setInt("texture2", 1);
